...
download.file(url = "https://export.hotosm.org/downloads/c602a7be-dbf7-45c1-abcc-ef197ea0f60d/hotosm_geo_roads_gpkg.zip",
              destfile = here("2023/openstreetmap/roads.zip"))
unzip(zipfile = here("2023/openstreetmap/roads.zip"), exdir = here("2023/open street map/"))
...
tibs_roads <- st_read(here("2023/openstreetmap/hotosm_geo_roads.gpkg")) %>% 
